...
<p class="info-text">Don't have an account? <a href="newuser.php">Create New Account</a></p>
        ...
        <legend style="color: blue;"> Login </legend>
            <table>
                <tbody>
                    <tr>
                         <td> <pre>Name </pre> </td>
                         <td> <input size="25" type="text" name="username" placeholder="Garv"  autocomplete="off" required></td>
                    </tr>
                    <tr>
